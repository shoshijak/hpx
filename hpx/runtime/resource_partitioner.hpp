...
namespace resource
{
    ...
    public:
        ...
        // shoshijak: the user could want to add a certain resource to the default
        // pool explicitely. This function exists to allow him to do so, without
        // having to know the name of the default pool
        // (ie i avoids calls like rp.add_resource(myresource,"default")
